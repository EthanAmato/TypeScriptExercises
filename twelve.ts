...
declare module 'stats' {
    ...
    export function getMaxIndex<T1>(input: T1[], comparator:  Comparator<T1>): number;
    export function getMaxElement<T1>(input: T1[], comparator:  Comparator<T1>): T1 | null;
    export function getMinIndex<T1>(input: T1[], comparator:  Comparator<T1>): number;
    export function getMinElement<T1>(input: T1[], comparator:  Comparator<T1>): T1 | null;
    export function getMedianIndex<T1>(input: T1[], comparator:  Comparator<T1>): number;
    export function getMedianElement<T1>(input: T1[], comparator:  Comparator<T1>): T1 | null;
